...
class ConfigValidator:
    ...
    def validate_all(self, settings) -> ValidationResult:
        ...
        self._check_range(result, "MAX_MARKETS_TO_SCAN", settings.MAX_MARKETS_TO_SCAN, 0, 10000)
        self._check_range(result, "MAX_EVENTS_TO_SCAN", settings.MAX_EVENTS_TO_SCAN, 0, 10000)
