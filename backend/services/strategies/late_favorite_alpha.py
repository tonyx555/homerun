...
LATE_FAVORITE_ALPHA_CONFIG_SCHEMA: dict[str, Any] = {
    "param_fields": [
        {"key": "min_favorite_prob", "label": "Min Favorite Probability", "type": "number", "min": 0.5, "max": 0.99, "phase": "signal"},
        {"key": "max_favorite_prob", "label": "Max Favorite Probability", "type": "number", "min": 0.5, "max": 0.995, "phase": "signal"},
        {"key": "min_hours_to_resolution", "label": "Min Hours To Resolution", "type": "number", "min": 0.0, "max": 24.0, "phase": "signal"},
        {"key": "max_hours_to_resolution", "label": "Max Hours To Resolution", "type": "number", "min": 0.1, "max": 72.0, "phase": "signal"},
        ...
        {"key": "require_spread_data", "label": "Require Spread Data", "type": "boolean", "phase": "signal"},
        ...
        {"key": "max_recent_move_pct", "label": "Max Recent Move (%)", "type": "number", "min": 0, "max": 100, "phase": "signal"},
        {"key": "time_alpha_scale", "label": "Time Alpha Scale", "type": "number", "min": 0.01, "max": 1.0, "phase": "signal"},
        {"key": "flow_alpha_scale", "label": "Flow Alpha Scale", "type": "number", "min": 0.0, "max": 1.0, "phase": "signal"},
        {"key": "momentum_alpha_scale", "label": "Momentum Alpha Scale", "type": "number", "min": 0.0, "max": 1.0, "phase": "signal"},
        {"key": "spread_friction_scale", "label": "Spread Friction Scale", "type": "number", "min": 0.0, "max": 2.0, "phase": "signal"},
        {"key": "min_alpha_prob", "label": "Min Alpha Probability", "type": "number", "min": 0.0005, "max": 0.25, "phase": "signal"},
