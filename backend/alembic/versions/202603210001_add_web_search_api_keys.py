"""Add web search provider API key columns to app_settings.
...
def upgrade() -> None:
    ...
    columns = [
        sa.Column("serpapi_key", sa.String(), nullable=True),
        sa.Column("brave_search_key", sa.String(), nullable=True),
    ]
    for col in columns:
